...
- `SMTP_*` — real email credentials so verification codes can actually send.
  For Gmail: turn on 2-Step Verification, then create an **App Password** and
  use that as `SMTP_PASS` (your normal Gmail password will not work).
